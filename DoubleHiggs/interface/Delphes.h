...
// Wed May  8 15:15:53 2013 by ROOT version 5.34/07
// from TTree Delphes/Analysis tree
// found on file: ../../data/AZh_14TEV_bb_1000_NoPileUp.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           GenJet_BTag[kMaxGenJet];   //[GenJet_]
   Int_t           GenJet_TauTag[kMaxGenJet];   //[GenJet_]
   ...
   Int_t           CAJet_BTag[kMaxCAJet];   //[CAJet_]
   Int_t           CAJet_TauTag[kMaxCAJet];   //[CAJet_]
   ...
   Int_t           Jet_BTag[kMaxJet];   //[Jet_]
   Int_t           Jet_TauTag[kMaxJet];   //[Jet_]
   ...
   Int_t           Photon_size;
   Int_t           BLJets_;
   UInt_t          BLJets_fUniqueID[kMaxBLJets];   //[BLJets_]
   UInt_t          BLJets_fBits[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_PT[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_Eta[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_Phi[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_Mass[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_DeltaEta[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_DeltaPhi[kMaxBLJets];   //[BLJets_]
   Int_t           BLJets_BTag[kMaxBLJets];   //[BLJets_]
   Int_t           BLJets_TauTag[kMaxBLJets];   //[BLJets_]
   Int_t           BLJets_Charge[kMaxBLJets];   //[BLJets_]
   Float_t         BLJets_EhadOverEem[kMaxBLJets];   //[BLJets_]
   TRefArray       BLJets_Constituents[kMaxBLJets];
   TRefArray       BLJets_Particles[kMaxBLJets];
   Int_t           BLJets_size;
   Int_t           Muon_;
   ...
   TBranch        *b_BLJets_;   //!
   TBranch        *b_BLJets_fUniqueID;   //!
   TBranch        *b_BLJets_fBits;   //!
   TBranch        *b_BLJets_PT;   //!
   TBranch        *b_BLJets_Eta;   //!
   TBranch        *b_BLJets_Phi;   //!
   TBranch        *b_BLJets_Mass;   //!
   TBranch        *b_BLJets_DeltaEta;   //!
   TBranch        *b_BLJets_DeltaPhi;   //!
   TBranch        *b_BLJets_BTag;   //!
   TBranch        *b_BLJets_TauTag;   //!
   TBranch        *b_BLJets_Charge;   //!
   TBranch        *b_BLJets_EhadOverEem;   //!
   TBranch        *b_BLJets_Constituents;   //!
   TBranch        *b_BLJets_Particles;   //!
   TBranch        *b_BLJets_size;   //!
   TBranch        *b_Muon_;   //!
...
void Delphes::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BLJets", &BLJets_, &b_BLJets_);
   fChain->SetBranchAddress("BLJets.fUniqueID", &BLJets_fUniqueID, &b_BLJets_fUniqueID);
   fChain->SetBranchAddress("BLJets.fBits", &BLJets_fBits, &b_BLJets_fBits);
   fChain->SetBranchAddress("BLJets.PT", &BLJets_PT, &b_BLJets_PT);
   fChain->SetBranchAddress("BLJets.Eta", &BLJets_Eta, &b_BLJets_Eta);
   fChain->SetBranchAddress("BLJets.Phi", &BLJets_Phi, &b_BLJets_Phi);
   fChain->SetBranchAddress("BLJets.Mass", &BLJets_Mass, &b_BLJets_Mass);
   fChain->SetBranchAddress("BLJets.DeltaEta", &BLJets_DeltaEta, &b_BLJets_DeltaEta);
   fChain->SetBranchAddress("BLJets.DeltaPhi", &BLJets_DeltaPhi, &b_BLJets_DeltaPhi);
   fChain->SetBranchAddress("BLJets.BTag", &BLJets_BTag, &b_BLJets_BTag);
   fChain->SetBranchAddress("BLJets.TauTag", &BLJets_TauTag, &b_BLJets_TauTag);
   fChain->SetBranchAddress("BLJets.Charge", &BLJets_Charge, &b_BLJets_Charge);
   fChain->SetBranchAddress("BLJets.EhadOverEem", &BLJets_EhadOverEem, &b_BLJets_EhadOverEem);
   fChain->SetBranchAddress("BLJets.Constituents", &BLJets_Constituents, &b_BLJets_Constituents);
   fChain->SetBranchAddress("BLJets.Particles", &BLJets_Particles, &b_BLJets_Particles);
   fChain->SetBranchAddress("BLJets_size", &BLJets_size, &b_BLJets_size);
